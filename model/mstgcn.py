...
class MSTGCN(nn.Module):
    ...
    def __init__(
        ...
        self._blocklist = nn.ModuleList(
            [MSTGCNBlock(args.in_channels, args.K, args.nb_chev_filter, args.nb_time_filter, args.time_strides)]
        )

        self._blocklist.extend(
            [
                MSTGCNBlock(args.nb_time_filter, args.K, args.nb_chev_filter, args.nb_time_filter, 1)
